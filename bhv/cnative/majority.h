...
void true_majority_into_avx2(word_t **xs, size_t size, word_t *target) {
    ...
    switch (size) {
        ...
        case 21: logic_majority_into_avx2<21>(xs, target); return;
        case 23: logic_majority_into_avx2<23>(xs, target); return;
        case 25: logic_majority_into_avx2<25>(xs, target); return;
        case 27: logic_majority_into_avx2<27>(xs, target); return;
        case 29: logic_majority_into_avx2<29>(xs, target); return;
        case 31: logic_majority_into_avx2<31>(xs, target); return;
        case 33: logic_majority_into_avx2<33>(xs, target); return;
        case 35: logic_majority_into_avx2<35>(xs, target); return;
        case 37: logic_majority_into_avx2<37>(xs, target); return;
        case 39: logic_majority_into_avx2<39>(xs, target); return;
        case 41: logic_majority_into_avx2<41>(xs, target); return;
        case 43: logic_majority_into_avx2<43>(xs, target); return;
        case 45: logic_majority_into_avx2<45>(xs, target); return;
        case 47: logic_majority_into_avx2<47>(xs, target); return;
        case 49: logic_majority_into_avx2<49>(xs, target); return;
        case 51: logic_majority_into_avx2<51>(xs, target); return;
        case 53: logic_majority_into_avx2<53>(xs, target); return;
        case 55: logic_majority_into_avx2<55>(xs, target); return;
        case 57: logic_majority_into_avx2<57>(xs, target); return;
        case 59: logic_majority_into_avx2<59>(xs, target); return;
        case 61: logic_majority_into_avx2<61>(xs, target); return;
        case 63: logic_majority_into_avx2<63>(xs, target); return;
        case 65: logic_majority_into_avx2<65>(xs, target); return;
        case 67: logic_majority_into_avx2<67>(xs, target); return;
        case 69: logic_majority_into_avx2<69>(xs, target); return;
        case 71: logic_majority_into_avx2<71>(xs, target); return;
        case 73: logic_majority_into_avx2<73>(xs, target); return;
        case 75: logic_majority_into_avx2<75>(xs, target); return;
        case 77: logic_majority_into_avx2<77>(xs, target); return;
        case 79: logic_majority_into_avx2<79>(xs, target); return;
        case 81: logic_majority_into_avx2<81>(xs, target); return;
        case 83: logic_majority_into_avx2<83>(xs, target); return;
        case 85: logic_majority_into_avx2<85>(xs, target); return;
        case 87: logic_majority_into_avx2<87>(xs, target); return;
        case 89: logic_majority_into_avx2<89>(xs, target); return;
